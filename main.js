...
3:[{n:'深海鳕鱼',i:'🐡',t:'food',h:40,r:3,w:20,minD:350,maxD:700},
   ...
   {n:'珍珠贝',i:'🦪',t:'cur',s:'shell',r:3,w:6,minD:350,maxD:700},
...
var CHEST_LOOT=[{n:'木板',i:'🪵',t:'mat',s:'wood',c:[2,5]},{n:'塑料瓶',i:'🧴',t:'mat',s:'plastic',c:[2,4]},{n:'金属片',i:'🔩',t:'mat',s:'metal',c:[1,3]},{n:'贝壳',i:'🐚',t:'cur',s:'shell',c:[1,3]},{n:'绳索',i:'🪢',t:'mat',s:'rope',c:[1,3]},{n:'珍珠',i:'💎',t:'cur',s:'shell',c:[1,2]}];
...
var BLDS=[
{id:'fire',n:'火堆',i:'🔥',lvs:[{d:'熟食回复×1.2·不降健康',c:{wood:3,plastic:2,shell:2}},{d:'解锁炖锅·×1.5',c:{wood:4,metal:3,shell:3}},{d:'解锁熏制',c:{wood:3,metal:4,rope:2,shell:4}},{d:'移动厨房',c:{metal:5,chip:1,obsidian:1,shell:8},bp:1}]},
{id:'shelter',n:'庇护所',i:'🏠',lvs:[{d:'休息+8体·船耐久+15',c:{wood:5,plastic:3,rope:2,shell:3}},{d:'休息+12体·风暴减伤30%·耐久+15',c:{wood:6,metal:4,rope:3,shell:5}},{d:'休息+18体·减伤60%·耐久+20',c:{wood:4,metal:6,rope:4,shell:6}},{d:'气象站·耐久+20',c:{metal:5,chip:1,obsidian:2,shell:10},bp:1}]},
{id:'storage',n:'储物箱',i:'📦',lvs:[{d:'背包20格',c:{wood:4,metal:2,shell:2}},{d:'背包35格',c:{wood:5,metal:4,shell:4}},{d:'背包50格',c:{wood:3,metal:5,rope:3,shell:6}},{d:'背包80格',c:{metal:6,chip:1,coldiron:2,shell:12},bp:1}]}
];

var BAG_LV=[16,20,35,50,80];

var SHOP=[{id:'bait',n:'鱼饵',i:'🪱',d:'下3次钓鱼品质+1',p:{shell:15},stk:5},{id:'repair',n:'修理锤',i:'🔧',d:'回复20生命',p:{shell:25},stk:3},{id:'map',n:'海图',i:'🗺️',d:'预览下个岛屿',p:{shell:35},stk:2},{id:'revive',n:'复活剂',i:'💊',d:'死亡自动复活',p:{shell:50},stk:1},{id:'radio',n:'旧收音机',i:'📻',d:'恢复精神+20（一次性）',p:{shell:60},stk:1}];

var TRADE_T=[
{g:{n:'沙丁鱼',i:'🐟',m:'沙丁鱼'},gn:3,r:{n:'木板',i:'🪵',t:'mat',s:'wood'},rn:3},
{g:{n:'鲈鱼',i:'🐠',m:'鲈鱼'},gn:2,r:{n:'贝壳',i:'🐚',t:'cur',s:'shell'},rn:2},
{g:{n:'木板',i:'🪵',m:'_wood'},gn:4,r:{n:'金属片',i:'🔩',t:'mat',s:'metal'},rn:2},
{g:{n:'海草',i:'🌿',m:'海草'},gn:5,r:{n:'绳索',i:'🪢',t:'mat',s:'rope'},rn:2},
{g:{n:'塑料瓶',i:'🧴',m:'_plastic'},gn:3,r:{n:'贝壳',i:'🐚',t:'cur',s:'shell'},rn:2},
{g:{n:'贝壳',i:'🐚',m:'_shell'},gn:6,r:{n:'金属片',i:'🔩',t:'mat',s:'metal'},rn:3},
{g:{n:'金枪鱼',i:'🐟',m:'金枪鱼'},gn:1,r:{n:'珍珠',i:'💎',t:'cur',s:'shell'},rn:1},
{g:{n:'绳索',i:'🪢',m:'_rope'},gn:2,r:{n:'木板',i:'🪵',t:'mat',s:'wood'},rn:5}
];

var ISLANDS=[
{hr:72,n:'无名小岛',i:'🏝️',d:'不起眼的小岛，有浆果和木料。',loot:[{n:'浆果',i:'🫐',t:'food',h:18,c:3},{n:'木板',i:'🪵',t:'mat',s:'wood',c:4}],req:null,minD:0,maxD:500},
{hr:200,n:'珊瑚礁岛',i:'🪸',d:'珊瑚环绕，浅滩散落贝壳和珍珠。',loot:[{n:'贝壳',i:'🐚',t:'cur',s:'shell',c:4},{n:'珍珠',i:'💎',t:'cur',s:'shell',c:1}],req:'hull',minD:150,maxD:600},
{hr:360,n:'神秘岛',i:'🌋',d:'薄雾笼罩，隐藏古老秘密...',loot:[{n:'精钢片',i:'⚙️',t:'mat',s:'metal',c:4},{n:'珍珠',i:'💎',t:'cur',s:'shell',c:2},{n:'神秘图纸',i:'📜',t:'bp',c:1}],req:'canvas',minD:350,maxD:700},
...
var SHIP_UP=[{id:'hull',n:'加固船底',i:'🔧',d:'前往珊瑚礁岛',c:{wood:6,metal:4,shell:5}},{id:'canvas',n:'防火帆布',i:'🧵',d:'前往神秘岛',c:{wood:4,metal:3,rope:4,shell:8}},{id:'ram',n:'破冰撞角',i:'⚔️',d:'前往火山/冰封',c:{metal:6,coldiron:2,obsidian:2,shell:12}}];

var TALENTS=[{id:'survival',n:'生存系',i:'🏕️',d:'开局带物资·饥饿-5%',fn:function(g){addI(g,'木板','🪵','mat','wood',1);addI(g,'淡水','💧','fresh',null,1);g._hMod*=0.95;}},{id:'fishing',n:'渔猎系',i:'🎣',d:'开局鱼竿Lv.2',fn:function(g){g.rod=2;}},{id:'explore',n:'探索系',i:'🧭',d:'航速+10%·首岛正面事件',fn:function(g){g._spMod*=1.1;g._firstEv=true;}}];

var RECIPES=[
{id:'bait_basic',n:'基础饵',i:'🪱',desc:'钓鱼品质+1（单次）',cost:{'海草':2,'淡水':1},result:{n:'基础饵',t:'mat',s:'bait',q:1}},
{id:'bait_glow',n:'夜光饵',i:'✨',desc:'钓鱼品质+2（深海额外稀有）',cost:{'荧光水母':3,'淡水':1,'贝壳':2},result:{n:'夜光饵',t:'mat',s:'bait_glow',q:1}},
{id:'herbal_tea',n:'草药茶',i:'🍵',desc:'恢复精神+15',cost:{'海草':2,'淡水':2},result:{n:'草药茶',t:'food',h:0,well:15,q:1}},
{id:'repair_kit',n:'简易修船套件',i:'🔧',desc:'修复船耐久+20',cost:{'木板':2,'金属片':1,'贝壳':3},result:{n:'修船套件',t:'mat',s:'repair_kit',q:1}}
];
...
// ========== RANDOM EVENTS (Sea) ==========
var SEA_EV=[
{id:'bottle',n:'漂流瓶',i:'🍾',ch:.12,desc:'海面漂来一个玻璃瓶，里面似乎有东西...',zone:['near','shelf'],
...
{id:'flyfish',n:'飞鱼群',i:'🐟',ch:.12,cond:function(g){return g.hour>=5&&g.hour<=8;},desc:'一群飞鱼掠过海面！',zone:['near','shelf'],
  opts:[{t:'🥅 张网拦截',fn:function(g){var c=2+Math.floor(Math.random()*3);addI(g,'飞鱼','🐟','food',null,c);return '捕获'+c+'条飞鱼！';}},{t:'👀 观看',fn:function(){return '飞鱼群远去了。';}}]},
...
{id:'ice',n:'浮冰区',i:'🧊',ch:.20,cond:function(g){return g.day>=25;},desc:'前方出现大片浮冰！',zone:['polar'],
  opts:[{t:'🔄 缓慢绕行',fn:function(g){adv(2);addI(g,'浮冰','🧊','mat','ice',8);return '绕行2小时，收集了8份浮冰（可融为淡水）。';}},{t:'💥 破冰直行',fn:function(g){g.stamina=Math.max(0,g.stamina-5);g.durability=Math.max(0,g.durability-5);return '破冰前进！体力-5，船耐久-5。';}}]},
{id:'volcano',n:'海上火山喷发',i:'🌋',ch:.10,cond:function(g){return g.visitedIslands&&g.visitedIslands.includes('火山群岛');},desc:'远处火山剧烈喷发，岩浆流入大海！',zone:['deep','polar'],
  opts:[{t:'🏃 全速逃离',fn:function(g){g.stamina=Math.max(0,g.stamina-15);adv(3);return '拼命逃离！体力-15，耗时3小时。';}},{t:'🪨 捡拾浮石',fn:function(g){var c=2+Math.floor(Math.random()*3);addI(g,'火山玻璃','🖤','mat','obsidian',c);g.hp=Math.max(0,g.hp-5);return '获得'+c+'块火山玻璃！但被碎石划伤，生命-5。';}}]},
...
{id:'coconut',n:'漂浮椰子树',i:'🥥',ch:.08,desc:'一棵连根拔起的椰子树在海面漂浮。',zone:['near','shelf'],
  opts:[{t:'🥥 捞起',fn:function(g){var c=2+Math.floor(Math.random()*3);addI(g,'椰子','🥥','food',null,c);addI(g,'淡水','💧','fresh',null,c);return '获得'+c+'个椰子和'+c+'份淡水！';}},{t:'⏩ 无视',fn:function(){return '椰子树漂走了。';}}]},
...
{id:'pre_storm',n:'暴风雨前夕',i:'⛈️',ch:.99,cond:function(g){return g._stormComing;},desc:'天色骤变，暴风雨即将来临！你还有3小时准备。',zone:['near','shelf','deep','polar'],
  opts:[{t:'🔧 加固木筏',fn:function(g){adv(2);if(cntSub(g,'wood')>=5&&cntSub(g,'metal')>=5&&g.shells>=5){consumeSub(g,'wood',5);consumeSub(g,'metal',5);g.shells-=5;g._stormPrep='half';return '消耗木料5+金属5+贝壳5，风暴损失减半！';}return '材料不足（需木料5+金属5+贝壳5），无法加固！';}},{t:'⛵ 提前收帆',fn:function(g){adv(1);g._stormPrep='slow';return '收帆降速，风暴中航速减半但损失降低。';}},{t:'😰 什么都不做',fn:function(g){g._stormPrep='none';return '听天由命...';}}]},
// ====== 新增事件 ======
{id:'shark_attack',n:'🦈 鲨鱼袭击木筏！',i:'🦈',ch:.08,cond:function(g){return g.dist>150 && g.hunger>50;},desc:'一条大白鲨猛烈撞击木筏，试图掀翻你！',zone:['shelf','deep'],
  opts:[{t:'⚔️ 搏斗',fn:function(g){g.stamina=Math.max(0,g.stamina-15);if(Math.random()<0.3){g.hp=Math.max(0,g.hp-10);return '搏斗中受伤！生命-10，体力-15。';}else{addI(g,'鲨鱼鳍','🦈','mat','sharkfin',2);return '击退鲨鱼！获得鲨鱼鳍×2，体力-15。';}}},
       {t:'🐟 丢鱼肉引开',fn:function(g){if(removeFood(g,3)){return '丢出3条鱼，鲨鱼追鱼而去。';}else{return '没有鱼可丢！只能搏斗。';}}},
       {t:'🚣 加速划走',fn:function(g){g.stamina=Math.max(0,g.stamina-5);g.durability=Math.max(0,g.durability-5);return '加速划走，体力-5，船耐久-5。';}}]},
{id:'pirate',n:'🏴‍☠️ 海盗船出没！',i:'🏴‍☠️',ch:.05,cond:function(g){return g.dist>200 && g.hour>=6 && g.hour<=18;},desc:'远方出现挂着骷髅旗的海盗船，正快速靠近！',zone:['shelf','deep'],
  opts:[{t:'💨 全速逃跑',fn:function(g){g.stamina=Math.max(0,g.stamina-10);if(Math.random()<0.5){adv(2);return '成功逃脱！体力-10，耗时2小时。';}else{g.durability=Math.max(0,g.durability-8);return '被追上了！船耐久-8，体力-10。';}}},
       {t:'🫥 躲藏',fn:function(g){adv(2);return '躲在雾里，2小时后海盗离开。';}},
       {t:'🪙 贿赂',fn:function(g){if(g.shells>=8){g.shells-=8;return '支付8贝壳，海盗满意离开。';}else{return '贝壳不够！准备迎战。';}}}]},
{id:'hunger_crisis',n:'⚠️ 饥饿危机！',i:'🍽️',ch:.99,cond:function(g){return countFood(g)<3 && g.hunger<30;},desc:'食物储备见底，你感到头晕目眩。必须立即行动！',zone:['near','shelf','deep','polar'],
  opts:[{t:'🎣 冒险捕鱼（成功率降低）',fn:function(g){var roll=Math.random();if(roll<0.3){addI(g,'沙丁鱼','🐟','food',null,2);return '运气不错，钓到2条沙丁鱼！';}else{return '一无所获，还浪费了体力。';}}},
       {t:'😴 节省体力（消耗减半，持续12h）',fn:function(g){g._hungerSave=true;g._hungerSaveTimer=12;return '你决定减少活动，饥饿消耗减半（持续12小时）。';}},
       {t:'🙏 祈祷',fn:function(g){if(Math.random()<0.3){g.well=Math.min(g.maxW,g.well+20);return '信仰之力！精神+20。';}else{g.hp=Math.max(0,g.hp-5);return '祈祷未应，精神受挫，生命-5。';}}}]},
{id:'driftwood',n:'🧑‍✈️ 遇难漂流者',i:'🧑‍✈️',ch:.04,cond:function(g){return (g._crew||0)<3;},desc:'一名遇难者趴在漂浮的木板上一动不动...',zone:['near','shelf'],
  opts:[{t:'🆘 救助',fn:function(g){if(removeFood(g,2)){g._crew=(g._crew||0)+1;return '救助成功！你多了一名船员。';}else{return '没有食物，无法救助...';}}},
       {t:'🔍 搜刮',fn:function(g){var c=2+Math.floor(Math.random()*2);g.shells+=c;return '从他身上找到'+c+'贝壳。';}},
       {t:'⏩ 离开',fn:function(){return '你继续航行。';}}]},
{id:'kraken',n:'🐙 深海巨怪！',i:'🐙',ch:.03,cond:function(g){return g.dist>600 && (g.hour>=20||g.hour<=4);},desc:'巨大触手从海底升起，缠绕木筏！',zone:['deep','polar'],
  opts:[{t:'⚔️ 拼死对抗',fn:function(g){g.stamina=Math.max(0,g.stamina-20);if(Math.random()<0.1){addI(g,'传说宝箱','💰','chest','chest_4',1);return '奇迹！击退巨怪，获得传说宝箱！';}else{return '搏斗失败，体力-20，巨怪离去。';}}},
       {t:'🌀 绕行',fn:function(g){adv(3);return '绕行3小时，安全了。';}},
       {t:'🍣 投食',fn:function(g){if(removeFood(g,5)){return '投喂5条鱼，巨怪满意离开。';}else{return '没有足够的鱼！';}}}]},
{id:'storm_enhanced',n:'🌪️ 强暴风雨！',i:'🌪️',ch:.12,desc:'飓风级暴风雨来袭，比以往更猛烈！',zone:['near','shelf','deep','polar'],
  opts:[{t:'🏝️ 寻找避风港',fn:function(g){if(Math.random()<0.2){var isl=ISLANDS[Math.floor(Math.random()*ISLANDS.length)];g.curIsl=isl;showIsland(isl);return '发现了一座小岛！可以躲避风暴。';}else{return '没有找到避风港，只能硬抗。';}}},
       {t:'🔧 加固',fn:function(g){if(g.shells>=10){g.shells-=10;g._stormPrep='half';return '花费10贝壳加固，损失减半。';}else{return '贝壳不足，无法加固。';}}},
       {t:'⛵ 收帆',fn:function(g){g._stormPrep='slow';return '收帆降速。';}}]}
];
...
{id:'boot',n:'钓到靴子',i:'👢',ch:.05,desc:'钓上来一只破旧的靴子...',zone:['near','shelf'],
  opts:[{t:'🔍 检查靴子',fn:function(g){var c=1+Math.floor(Math.random()*2);g.shells+=c*2;return '靴子里藏有'+c+'枚古代钱币（'+c*2+'贝壳）！';}},{t:'🗑️ 扔回海里',fn:function(){return '你把靴子扔了回去。';}}]},
...
{id:'monster',n:'咬钩巨物',i:'👹',ch:.12,cond:function(g){return g.hour>=20||g.hour<=4;},desc:'鱼竿几乎被拖走！水下有个巨大的影子...',zone:['deep','polar'],
  opts:[{t:'⚔️ 拼命搏斗',fn:function(g){adv(2);g.stamina=Math.max(0,g.stamina-15);if(Math.random()<0.3){addI(g,'龙鱼','🐉','food',null,1);return '经过殊死搏斗，钓上了传说中的龙鱼！（体力-15）';}return '搏斗了2小时，巨物挣脱逃走了...（体力-15）';}},{t:'😨 放弃',fn:function(){return '你明智地放手了。';}}]},
...
{n:'洞穴回声',i:'🕳️',desc:'岛上有个深邃的洞穴，里面传来回声...',opts:[{t:'🔦 深入探索',fn:function(g){adv(2);if(Math.random()<0.4){addI(g,'神秘图纸','📜','bp',null,1);return '在洞穴深处找到了蓝图碎片！';}addI(g,'金属片','🔩','mat','metal',4);return '发现了一些稀有矿石。';}},{t:'👀 洞口查看',fn:function(g){adv(1);addI(g,'木板','🪵','mat','wood',3);return '洞口捡了些材料。';}},{t:'❌ 不进去',fn:function(){return '你决定不冒险。';}}]},
{n:'果树茂盛',i:'🌳',desc:'岛上有一片茂盛的果树！',opts:[{t:'🧺 大量采摘',fn:function(g){adv(1);var c=4+Math.floor(Math.random()*4);addI(g,'水果','🍎','food',null,c);return '采摘了'+c+'个水果！';}},{t:'✨ 挑最好的',fn:function(g){adv(1);addI(g,'精品水果','🍑','food',null,3);g.invI['精品水果']='🍑';return '获得3个精品水果（恢复效果翻倍）！';}}]},
{n:'动物脚印',i:'🐾',desc:'地上有新鲜的动物脚印...',opts:[{t:'👣 追踪',fn:function(g){adv(2);if(Math.random()<0.5){addI(g,'毛皮','🟫','mat','leather',2);return '追踪到动物巢穴，获得毛皮×2！';}addI(g,'鸟蛋','🥚','food',null,4);return '发现一窝鸟蛋×4！';}},{t:'⏩ 无视',fn:function(){return '你继续前行。';}}]},
...
{n:'古老石碑',i:'🗿',desc:'岛上矗立着一块古老的石碑...',opts:[{t:'📝 拓印碑文',fn:function(g){adv(1);addI(g,'知识碎片','📜','bp',null,1);return '拓印了碑文，获得知识碎片！';}},{t:'⛏️ 挖掘碑底',fn:function(g){adv(2);var c=4+Math.floor(Math.random()*4);g.shells+=c;return '挖到'+c+'枚古代钱币（'+c+'贝壳）！';}}]},
...
{n:'陷阱坑',i:'⚠️',desc:'前方有个隐蔽的陷阱坑！',opts:[{t:'🔄 小心绕过',fn:function(){return '你小心地绕过了。';}},{t:'👀 查看坑底',fn:function(g){if(Math.random()<0.5){addI(g,'海龟','🐢','mat','pet',1);return '坑底有一只被困的海龟，你收养了它！';}return '坑底空空的。';}}]},
...
{n:'翡翠矿脉',i:'💎',desc:'岩壁上露出闪闪发光的翡翠矿脉！',opts:[{t:'⛏️ 开采',fn:function(g){adv(3);g.stamina=Math.max(0,g.stamina-20);var c=1+Math.floor(Math.random()*2);g.shells+=c*8;return '耗时3小时，体力-20，获得翡翠，折合'+c*8+'贝壳！';}},{t:'📝 记录位置',fn:function(){return '你记下了矿脉位置。';}}]},
...
{id:'market',n:'海上集市',i:'🏪',ch:.03,desc:'远处出现一支海上商队！',zone:['near','shelf'],
  opts:[{t:'🤝 停靠交易',fn:function(g){adv(2);g.shells+=8;return '与商队交易了2小时，获得8贝壳！';}},{t:'⏩ 快速通过',fn:function(){return '商队远去了。';}}]},
{id:'archaeo',n:'考古船求救',i:'🚢',ch:.04,desc:'一艘考古船发出求救信号！',zone:['shelf','deep'],
  opts:[{t:'🔧 协助修复',fn:function(g){adv(3);g.shells+=15;return '考古学家赠送了古董，价值15贝壳！';}},{t:'💰 索取报酬',fn:function(g){g.shells+=20;return '获得20贝壳！';}},{t:'⏩ 离开',fn:function(){return '你没有停留。';}}]},
...
function useC(g,c){
  for(var k in c){
    var r=c[k];
    if(k==='shell'){g.shells-=r; continue;}
    for(var inv in g.inv){
      var i=g.invT[inv];
      if(i&&(i.s===k||inv===k)){
...
function save(){
  if(G){
    try{
      G._v = VERSION;
      localStorage.setItem('raft3',JSON.stringify(G));
    }catch(e){}
  }
}
function load(){
  try{
    ...
    if(s){
      ...
      // 基本校验
      if(data && typeof data.day==='number' && typeof data.hp==='number' && typeof data.hunger==='number'){
        // 兼容旧版本：如果缺少_v或版本低于当前，尝试修复
        if(!data._v || data._v < VERSION){
          // 简单迁移：合并贝壳/钻石
          if(data.pearls !== undefined){
            data.shells = (data.shells||0) + data.pearls;
            delete data.pearls;
          }
          data._v = VERSION;
        }
        G = data;
        // 确保新字段存在
        if(G._hungerSave === undefined) G._hungerSave = false;
        if(G._hungerSaveTimer === undefined) G._hungerSaveTimer = 0;
        return true;
      }
    }
  }catch(e){}
...
function adv(h){
  ...
  for(var i=0;i<h;i++){
    ...
    G.dist+=sp;
    var hd=1.8*(G._hMod||1);
    if(G.trait==='camel'){hd*=0.8;}
    if(G._hungerSave && G._hungerSaveTimer>0){
      hd*=0.5;
      G._hungerSaveTimer--;
      if(G._hungerSaveTimer<=0) G._hungerSave=false;
    }
    ...
    if(G.hour===9 && Math.random()<0.15 && !G._stormComing){G._stormComing=true;}
    if(G.hour===12 && G._stormComing){G._stormComing=false;triggerStorm();}
    if(G.hour%6===0 && G.hour!==G._lastEv && Math.random()<0.30){
...
function triggerStorm(){
  ...
  var durDmg=Math.floor((18+Math.random()*25)*(1-red));
  var hpDmg=Math.floor((10+Math.random()*15)*(1-red));
  G.durability=Math.max(0,G.durability-durDmg);
  G.hp=Math.max(0,G.hp-hpDmg);
  var lost='';
  if(red<0.3){lost=dropRandom(G,Math.ceil(Math.random()*4));}
...
function doFish(){
  ...
  if(catch_.t==='chest'){
    ...
    if(catch_.s==='shell'){
      var n2=1+Math.floor(Math.random()*2); // 减少贝壳产出
      G.shells+=n2;
      addLog('🎣 '+catch_.i+catch_.n+'，+'+n2+'贝壳！','reward');
    } else {
      // 其他cur类统一给贝壳
      G.shells+=2;
      addLog('🎣 '+catch_.i+catch_.n+'，+2贝壳！','reward');
    }
...
function craftRecipe(rid){
  ...
  }else if(res.s==='repair_kit'){
    G.durability=Math.min(G.maxDur,G.durability+20);
    addLog('🔧 使用修船套件，耐久+20！','reward');
  }else{
    if(totalBag(G) < G.bagMax){
...
function openChest(n){
  ...
  var lvMap={'chest_1':1,'chest_2':2,'chest_3':3,'chest_4':4};
  var level=lvMap[info.s]||1;
  var count=1+Math.floor(level/2);
  var items=[];
...
function renderCraft(){
  ...
  for(var bIdx=0;bIdx<BLDS.length;bIdx++){
    ...
    if(nx){
      ...
      for(var ce=0;ce<cEntries.length;ce++){
        ...
        var nm={wood:'木',plastic:'塑',metal:'金',rope:'绳',chip:'芯',coldiron:'寒铁',obsidian:'曜',shell:'贝'};
        var have = (k==='shell')?G.shells:cntSub(G,k);
        csParts.push((nm[k]||k)+''+have+'/'+v);
      }
      cs=csParts.join(' ');
      if(needBp) cs+=' 📜需图纸';
    }
    var d=document.createElement('div');
    d.className='ci';
    d.innerHTML='<span class="ci-icon">'+b.i+'</span><div class="ci-info"><div class="ci-name">'+b.n+' <span style="font-size:8px;color:#a09880">'+(lv?'Lv.'+lv:'未建')+'</span></div><div class="ci-desc">'+(lv>0?b.lvs[lv-1].d:'未建造')+'</div>'+(nx?'<div class="ci-cost">'+cs+'</div>':'')+'</div><button class="cb '+(mx?'built':'')+'" '+(mx||!can?'disabled':'')+' data-build="'+b.id+'">'+(mx?'满级':lv?'升级':'建造')+'</button>';
    cl.appendChild(d);
  }
  ...
  if(nr){
    ...
    for(var ce2=0;ce2<cEntries2.length;ce2++){
      ...
      var nm2={wood:'木',plastic:'塑',metal:'金',rope:'绳',chip:'芯',coldiron:'寒铁',obsidian:'曜',shell:'贝'};
      var have=(k==='shell')?G.shells:cntSub(G,k);
      csParts2.push((nm2[k]||k)+''+have+'/'+v);
    }
...
function renderShop(){
  ...
  for(var idx=0;idx<SHOP.length;idx++){
    ...
    var pv=it.p[pk];
    var cur=pk==='shell'?'🐚':'💎';
    var can=stk>0&&(pk==='shell'?G.shells:G.shells)>=pv;
    var d=document.createElement('div');
    d.className='si';
    d.innerHTML='<span class="si-icon">'+it.i+'</span><div class="si-info"><div class="si-name">'+it.n+' <span style="font-size:8px;color:#a09880">×'+stk+'</span></div><div class="si-desc">'+it.d+'</div></div><span class="si-price">'+cur+pv+'</span><button class="td" '+(can?'':'disabled')+' data-shop="'+it.id+'">买</button>';
    l.appendChild(d);
  }
...
function trade(i){
  ...
  if(t.r.t==='cur'){
    if(t.r.s==='shell'){G.shells+=t.rn;}else{G.shells+=t.rn;}
...
function renderCrew(){
  ...
  list.innerHTML='';
  if(count===0){
    list.innerHTML='<div style="color:#8a7e6e;font-size:10px;padding:4px">暂无船员，在岛屿事件中可能救起遇难者。</div>';
    return;
  }
  for(var i=0;i<count;i++){
...
function exploreIsland(){
  ...
  for(var idx=0;idx<isl.loot.length;idx++){
    ...
    if(l.t==='cur'){
      ...
      else{G.shells+=l.c;loot.push('🐚×'+l.c);}
    }else{
      if(totalBag(G) < G.bagMax){
...
function handleDeath(){
  ...
  try{localStorage.setItem('raft3inh',JSON.stringify({pts:pts}));}catch(e){}
...
function startGame(trait,inh){
  ...
  refreshTrades();
  addI(G,'木板','🪵','mat','wood',1);
  addI(G,'淡水','💧','fresh',null,1);
...
function addLog(text,type){
  ...
  while(a.children.length>150){a.removeChild(a.firstChild);}
}
...
function upd(){
  ...
  document.getElementById('shellDisplay').textContent=G.shells;
  ...
  if(G._hungerSave){bb.innerHTML+='<span class="buff-tag">🍽️节能</span>';}
